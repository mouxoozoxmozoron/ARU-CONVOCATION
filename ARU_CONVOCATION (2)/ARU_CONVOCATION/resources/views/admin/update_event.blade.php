...
<center>
    <div id="anno" class="content-wrapper)">
        <form class="was-validated" action="{{ route('event_update_check') }}" method="POST" enctype="multipart/form-data">
      
        @csrf
        
    <div id="anno_tittle" >
        <h3 class="an_tittle">News/Event Update</h3>  
       
      </div>

      <div class="mb-3">
        <label for="validationTextarea" class="form-label">Event/News Tittle</label>
        <input type="text" class="form-control is-invalid" value="{{$details->tittle}}" name="event_tittle" id="validationTextarea" placeholder="" required>
      </div>
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control is-invalid" name="event_details" id="validationTextarea" placeholder="" required>{{$details->description}}</textarea>
      </div>
        ...
        <div class="mb-3">             
          <label for="validationTextarea" class="form-label">Video URL <P color="green" >Optional</P> </label>
        <input type="text" class="form-control" value="{{$details->video_url}}"  name="video_url" aria-label="file example" >
      </div>

        <div class="mb-3">
            <label for="validationTextarea" class="form-label">File</label>
          <input type="file" class="form-control" video_url name="file" aria-label="file example" >
        </div>
        
        <input type="hidden" name="id_update" value="{{ $details->event_id }}">

        <div id="publish_btn" class="col-12">
