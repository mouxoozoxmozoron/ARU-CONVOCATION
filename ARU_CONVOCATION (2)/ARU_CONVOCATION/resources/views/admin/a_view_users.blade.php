   ...
   <table id="table" class="table table-striped table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><img src="profile_photo/{{$users->file}}" class="card-img-top" alt="..."></td>
        ...
        <td id="dbtn" >
            ...
            @if($users->status == 0)
            <td>
        <a class="btn btn-primary" href={{"Account_aprove/".$users->id}} role="button">Aprove</a>
      </td>
        @endif

        @if($users->behavior == 1 && $users->status == 1)
        <td>
        <a class="btn btn-success"  href={{"Account_block/".$users->id}} role="button">Active</a>
      </td>
        @endif

        @if($users->behavior == 0)
        <td>
        <a class="btn btn-warning" href={{"Account_un_block/".$users->id}} role="button">Blocked</a>
      </td>
        @endif
      ...
      <td>
        <a id="dbtn" class="btn btn-danger" href={{"Account_delete/".$users->id}} role="button">Delete</a>
      </td>
