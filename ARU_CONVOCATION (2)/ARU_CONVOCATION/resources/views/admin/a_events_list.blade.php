  ...
  <div class="container" id = "top-header">
   ...
   <table id="table" class="table table-striped table-hover">
    ...
    <tbody>
      ...
      <tr>
        @foreach($eventsnews_list as $event)
        <td><img src="event_files/{{$event->file}}" class="card-img-top" alt="..."></td>
        <td>{{$event->tittle}}</td>
        ...
        <td id="dbtn" >
            ...
            <td>
            <a class="btn btn-warning" href={{"event_publish/".$event->event_id}} role="button">Publish</a>
          </td>
            @endif
        ...
        <td>
        <a class="btn btn-success"  href={{"event_unpublish/".$event->event_id}} role="button">Unpublish</a>
      </td>
        @endif
    
      
    <td>
        <a class="btn btn-primary" href={{"event_update/".$event->event_id}} role="button">Update</a>
    </td>

    <td>
        <a id="dbtn" class="btn btn-danger" href={{"event_delete/".$event->event_id}} role="button">Delete</a>
    </td>
...
@if(session('event_publish_success'))
<script type="text/javascript" >
    alert('Event Published');
</script>
@endif

@if(session('event_un_publish_success'))
<script type="text/javascript" >
    alert(' Event Un-published-');
</script>
@endif
